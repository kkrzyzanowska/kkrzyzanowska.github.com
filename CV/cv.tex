...
No. 4, pp. 771-792, 2014.
  ...
  \begin{itemize}
\item \emph{Between ``if'' and ``then.'' What do we learn when we learn a conditional?} at the sypomsium \emph{If, then, otherwise: A symposium on conditionals}, 23rd Annual Meeting of the European Society for Philosophy and Psychology (\href{http://espp2015.ut.ee}{ESPP2015}), Tartu, Estonia, 14-17 July 2015.
