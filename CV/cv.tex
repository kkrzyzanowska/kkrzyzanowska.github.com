...
\begin{small}
  ...
  \begin{itemize}
  \item Research fellow at the \emph{Munich Center for Mathematical Philosophy} in the project
  \href{http://www.pfeifer-research.de/spp.html}{``Rational reasoning with conditionals and probabilities. Logical foundations and empirical evaluations''} within the DFG Priority Program SPP 1516 ``New Frameworks of Rationality''.\\
...
\item Comment on Matteo Colombo's presentation \emph{Explanatory Reasoning, Moral Value, and Economic Incentive. Or\ldots How much is your moral judgment?} 
  ...
  \item Computer skills: \LaTeX$_{2e}$, MS Office and OpenOffice.org, basics of
